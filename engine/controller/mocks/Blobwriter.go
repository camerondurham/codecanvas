...
// Source: ./engine/controller/blobwriter.go
...
func (m *MockBlobWriter) Write(blob *controller.Blob) error {
	m.ctrl.T.Helper()
...
// Write mocks base method.
func (m *MockBlobWriterRemover) Write(blob *controller.Blob) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Write", blob)
	ret0, _ := ret[0].(error)
	return ret0
